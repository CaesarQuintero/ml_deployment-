...
class TextProcessing:
    ...
    def run(self, file_name: str, version: int):
        ...
        PATH_DATA_RAW = "C:\\Users\\cesar.guerra\\Documents\\Rappi\\Temas personales\\Platzi\\Curso de despliegue y tracking MLFLOW\\Mlops-platzi\\orchestration\\data\\data_raw"
        PATH_DATA_PROCESSED = "C:\\Users\\cesar.guerra\\Documents\\Rappi\\Temas personales\\Platzi\\Curso de despliegue y tracking MLFLOW\\Mlops-platzi\\orchestration\\data\\data_processed"
        # reading JSON data
